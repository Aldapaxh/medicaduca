...
import { TRADUCCIONES, IDIOMAS } from '../lib/traducciones'
...
export default function Page() {
  ...
  useEffect(() => {
    // Cargar idioma guardado del navegador (no del sistema operativo)
  ...
  if (pantalla === 'cargando') {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-gray-400 text-sm">{TRADUCCIONES[idioma]?.cargando || 'Cargando...'}</div>
      </div>
    )
  }
