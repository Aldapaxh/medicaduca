      ...
      <div className="prose prose-sm space-y-4 text-gray-700">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong>Preferencias</strong>: si quieres recibir avisos por email o no.</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li><strong>Modificar</strong> tu nombre, contraseña y preferencias desde tu perfil.</li>
